...
This is the canonical ARM-visible firmware contract for the proposed XC7Z020
programmable-logic FFT block. The separately versioned NeptuneSDR digital twin
implements this contract in QEMU. Its QEMU register definitions must refine
the machine-readable `specs/p210-firmware-interface-v1.json` in this repository.
...
The digital twin maps this block only in its P210-enabled QEMU machine. A derived
