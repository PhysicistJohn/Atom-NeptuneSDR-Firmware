...
CACHE_DIR=${FIRMWARE_CACHE_DIR:-"$ROOT/.cache/firmware"}
RUNTIME_OUTPUT=${FIRMWARE_RUNTIME_OUTPUT:-"$ROOT/.cache/p210-runtime"}
...
"$PYTHON" -m neptunesdr_firmware validate-xsa \
